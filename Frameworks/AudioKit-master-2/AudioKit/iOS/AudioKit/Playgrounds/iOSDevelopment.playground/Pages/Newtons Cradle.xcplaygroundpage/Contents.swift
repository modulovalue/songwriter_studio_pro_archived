...
let newtonsCradle = NewtonsCradle(colors:
    [#colorLiteral(red: 0.878, green: 0.381, blue: 0.577, alpha: 1),
    #colorLiteral(red: 0.220, green: 0.702, blue: 0.959, alpha: 1),
    #colorLiteral(red: 0.917, green: 0.4121, blue: 0.284, alpha: 1),
    #colorLiteral(red: 0.522, green: 0.8, blue: 0.346, alpha: 1)])
/*:
 ### Size and spacing
